...
retriever_config = RetrieverToolConfig(
    ...
    tool_description_prompt="Search for documents that are relevant to a user's query about Databricks documentation and e-books on GenAI, ML, ML Ops, Data Engineering, and more.",
)
...
llm_config = LLMConfig(
    ...
    llm_system_prompt_template=(
        """You are a helpful assistant that answers questions by calling tools based on Databricks documentation and e-books about GenAI, ML, Data Engineering, Security, etc.  Provide responses ONLY based on the information from tools that are explictly specified to you.  If you do not have a relevant tool for a question, respond with 'Sorry, I'm not trained to answer that question'."""
    ),
